...
public class YandexDiskLoginPageObject {
    ...
    public YandexDiskLoginPageObject(WebDriver driver) {
        if (browser == null) {
            browser = new Browser(driver);
        }
    }

    public YandexDiskLoginPageObject openPage() {
        browser.getDriver().manage().window().maximize();
        browser.getDriver().get(URL);
        return this;
    }

    public YandexDiskLoginPageObject typeLogin(String login) {
        browser.typeText(FIELD_FOR_LOGIN_LOCATOR, login);
        return this;
    }

    public YandexDiskLoginPageObject clickOnLogin() {
        browser.clickOnButton(BUTTON_LOGIN_LOCATOR);
        return this;
    }

    public YandexDiskLoginPageObject typePassword(String password) {
