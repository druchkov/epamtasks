...
public class YandexDiskPageObject {
    private static final By BUTTON_CREATE_LOCATOR = By.xpath("//div[@class = 'sidebar__buttons']//button");
    private static final By BUTTON_CREATE_NEW_FOLDER_LOCATOR = By.xpath("//span[text() = 'Папку']/..");
    ...
    public YandexDiskPageObject(WebDriver driver) {
        if (browser == null) {
    ...
    public YandexDiskPageObject createNewFolder(String nameFolder) {
    ...
    public YandexDiskPageObject moveFileInTresh(String nameFile) {
        browser.moveItemInOtherItem(createLocatorForFilesByName(nameFile), TRASH_LOCATOR);
        return this;
    }

    public YandexDiskPageObject createFolderFromContextMenu(String nameFolder) {
